...
export default {
  ...
  methods: {
    ...
    getBackgroundUrl(pic) {
      return `url(${require("../../assets/header/" + pic)})`;
    },
    getImgUrl(pic) {
      let isActive = pic === this.indexSlide;
      switch (isActive) {
        case true:
          return require("../../assets/header/slide-active-dots.png");
        default:
          return require("../../assets/header/slide-dots.png");
      }
    }
  },
  mounted() {
